...
| Endpoint | `POST https://app-blbnihghgum9-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-blbnihghgum9-api-baBw2m51JXz9-gateway.appmiaoda.com` |
...
async function queryCaipiaoResult(
  ...
  const url =
    `https://app-blbnihghgum9-api-baBw2m51JXz9-gateway.appmiaoda.com/caipiao/query?${params.toString()}`;
