...
- **Endpoint**: `POST https://app-blbnihghgum9-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query`
...
async function queryDrivingExamQuestions(
  ...
  const response = await fetch(
    `https://app-blbnihghgum9-api-o9wN0mk1DAPa-gateway.appmiaoda.com/driverexam/query?${params.toString()}`,
    {
      method: "POST",
      headers: {
