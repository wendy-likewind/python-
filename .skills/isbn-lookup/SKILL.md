...
- **Endpoint**：`POST https://app-blbnihghgum9-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-blbnihghgum9-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
