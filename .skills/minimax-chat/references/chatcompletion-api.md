...
| Endpoint | `POST https://app-blbnihghgum9-api-Aa2PqMJnJGwL-gateway.appmiaoda.com/v1/text/chatcompletion_v2` |
| Third-party Domain | `app-blbnihghgum9-api-Aa2PqMJnJGwL-gateway.appmiaoda.com` |
...
async function callMiniMaxChat(request: ChatCompletionRequest): Promise<ChatCompletionResponse> {
  const response = await fetch(
    "https://app-blbnihghgum9-api-Aa2PqMJnJGwL-gateway.appmiaoda.com/v1/text/chatcompletion_v2",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
