...
| third_part_domain | `app-blbnihghgum9-api-DY8MN3QBydBa-gateway.appmiaoda.com` |
...
| 方法 | POST |
| Endpoint | `https://app-blbnihghgum9-api-DY8MN3QBydBa-gateway.appmiaoda.com/v1/videos/image2video` |
...
| 方法 | GET |
| Endpoint | `https://app-blbnihghgum9-api-zYkZzgKook1L-gateway.appmiaoda.com/v1/videos/image2video/{id}` |
| 计费 | 不启用 |
...
| 方法 | GET |
| Endpoint | `https://app-blbnihghgum9-api-n9QVoDJ6oykL-gateway.appmiaoda.com/v1/videos/image2video` |
| 计费 | 不启用 |
...
async function submitImage2VideoTask(params: {
  ...
  const response = await fetch(
    "https://app-blbnihghgum9-api-DY8MN3QBydBa-gateway.appmiaoda.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function queryImage2VideoTask(taskId: string): Promise<{
  ...
  const response = await fetch(
    `https://app-blbnihghgum9-api-zYkZzgKook1L-gateway.appmiaoda.com/v1/videos/image2video/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
async function listImage2VideoTasks(pageNum = 1, pageSize = 30): Promise<Array<{
  ...
  const response = await fetch(
    `https://app-blbnihghgum9-api-n9QVoDJ6oykL-gateway.appmiaoda.com/v1/videos/image2video` +
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- 查询任务 ---
  const upstream = await fetch(
    `https://app-blbnihghgum9-api-zYkZzgKook1L-gateway.appmiaoda.com/v1/videos/image2video/${task_id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
