...
- **Endpoint**: `GET https://app-blbnihghgum9-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get`
...
async function verifyCompanyThreeFactors(
  ...
  const response = await fetch(
    `https://app-blbnihghgum9-api-Aa2PZnjE80BL-gateway.appmiaoda.com/company_three/get?${params.toString()}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json;charset=UTF-8",
...
- **third_part_domain**: `app-blbnihghgum9-api-Aa2PZnjE80BL-gateway.appmiaoda.com`
