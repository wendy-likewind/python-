...
| Endpoint | `POST https://app-blbnihghgum9-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit` |
| Content-Type | `application/json` |
| third_part_domain | `app-blbnihghgum9-api-ra5EZDjVKkXa-gateway.appmiaoda.com` |
...
| Endpoint（Web） | `POST https://app-blbnihghgum9-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task` |
| Endpoint（MiniProgram） | `GET https://app-blbnihghgum9-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task?taskId={taskId}` |
| Content-Type | `application/json` |
| third_part_domain | `app-blbnihghgum9-api-VaOwP2jDmAga-gateway.appmiaoda.com` |
| 计费 | 不启用 |
...
async function submitTextToImage(prompt: string): Promise<string> {
  const response = await fetch(
    "https://app-blbnihghgum9-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
async function queryTaskStatus(taskId: string): Promise<{
  ...
  const response = await fetch(
    "https://app-blbnihghgum9-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
