...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 提交任务 | POST | `https://app-blbnihghgum9-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit` |
| 查询状态 | POST/GET | `https://app-blbnihghgum9-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task` |
