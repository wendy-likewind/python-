...
- **Endpoint**：`GET https://app-blbnihghgum9-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard`
...
async function verifyIdCardTwoFactor(
  ...
  const response = await fetch(
    `https://app-blbnihghgum9-api-oLpZ74noWOMa-gateway.appmiaoda.com/idcard?${params.toString()}`,
    {
      method: "GET",
      headers: {
